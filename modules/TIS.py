...
class TIS:
    ...
    def __init__(self,serial, width, height, framerate, color):
        ...
        try:
            ...
            print(colored('Pipeline is created!', 'yellow'))
    ...
    def on_new_buffer(self, appsink):
        #print(colored('on_new_buffer is called!', 'yellow')) #----------------------- PRINT()
        self.newsample = True
        if self.samplelocked is False:
            try:
                ...
                if self.ImageCallback is not None:
                    ...
                    print(colored('ImageCallback is working!', 'yellow')) #----------------------- PRINT()
            except GLib.Error as error:
    ...
    def Start_pipeline(self):
        try:
            ...
            self.pipeline.get_state(Gst.CLOCK_TIME_NONE)
            print(colored('Pipeline is started!', 'yellow')) #----------------------- PRINT()
